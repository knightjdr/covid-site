  ...
  <div className="protein-nav__cell">
    ...
    >
      ...
      >
        <path
          className="protein-nav__cell_dark"
          d="M279.8,167.4c6.9-1.3,13.9,5.1,15.7,14.2l5.8,29.8c1.8,9.2-2.4,17.7-9.2,19.1c-6.9,1.3-13.9-5.1-15.7-14.2
          l-5.8-29.8C268.8,177.3,273,168.7,279.8,167.4z"
        />
        <path
          className="protein-nav__cell_light"
          d="M284.6,222c-1.3-0.9-2.5-2-3.3-3.3c-0.4-0.6-0.7-1.3-0.7-2c-0.1-1.8,1.1-1.4,2.7-1.7c0.8-0.1,1.4-0.5,2.1-0.6
