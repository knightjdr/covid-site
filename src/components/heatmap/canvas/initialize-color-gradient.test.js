...
describe('Initialize color gradient', () => {
  it('should generate a blue-black color gradient', () => {
    expect(initializeColorGradient('blue', 11)).toEqual(gradients.blue);
  });

  it('should generate a green-black color gradient', () => {
    expect(initializeColorGradient('green', 11)).toEqual(gradients.green);
  });

  it('should generate a greyscale color gradient', () => {
    expect(initializeColorGradient('greyscale', 11)).toEqual(gradients.greyscale);
  });

  it('should generate a red-black color gradient', () => {
    expect(initializeColorGradient('red', 11)).toEqual(gradients.red);
  });

  it('should generate a yellow-black color gradient', () => {
    expect(initializeColorGradient('yellow', 11)).toEqual(gradients.yellow);
  });

  it('should generate a default blue gradient', () => {
    expect(initializeColorGradient('default', 11)).toEqual(gradients.blue);
  });
});
